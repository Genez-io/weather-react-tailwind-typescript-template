...
export default function WeatherApp() {
    ...
    const [weather, setWeather] = useState<WeatherInfo | WeatherError | undefined>(undefined);
...
function Header({
    ...
    return (
        <div className="flex flex-row items-center">
            ...
            <div className="flex flex-row w-[11rem] pr-2">
                <Logo width={100} />
                <Typography variant="h5" className=" ml-0.5 text-[#725ac1]">
                    Weather
                </Typography>
            </div>
        </div>
        ...
        return (
            <div className="flex flex-col justify-center items-center h-full">
                <div className="[&>*]:w-[10rem] [&>*]:h-[10rem]">
                    <ReactAnimatedWeather icon="PARTLY_CLOUDY_DAY" size={300} color="white" />
                </div>
    ...
    return (
        <div className="flex flex-col h-full justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <WeatherBadge title="Precipitation" value={`${weather.precipitation} mm`} />
